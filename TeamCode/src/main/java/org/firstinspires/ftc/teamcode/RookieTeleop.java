...
@Config
@TeleOp(name="RookieTeleop", group = "Concept")
//@Disabled
...
//    private HuskyLens frontCam;
    ...
    public void runOpMode()
    {
        ...
        climbLeft = hardwareMap.get(DcMotor.class, "lla");
        climbRight = hardwareMap.get(DcMotor.class, "rla");
        ...
        hookRight = hardwareMap.get(Servo.class, "hookR");
        hookLeft = hardwareMap.get(Servo.class, "hookL");
//        -
        ...
        windMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
