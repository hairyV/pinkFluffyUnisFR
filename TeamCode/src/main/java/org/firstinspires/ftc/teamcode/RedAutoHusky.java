...
//public class RedAutoHusky extends LinearOpMode {
//
...
////
////        DuckPipline detector = new DuckPipline(telemetry);
...
//                .lineToLinearHeading(new Pose2d(41,31,Math.toRadians(180)))
//                .build();
//
...
//                .lineToLinearHeading(new Pose2d(41, 26, Math.toRadians(180)))
//                .build();
//
...
//            }
//
//            if((globalX > 235 && globalX < 265) && (globalY > 135 && globalY < 165)){
//                pos = 3;//right
//            }
//
//            //261,161
