...
//            }
            ...
            if(gamepad1.right_trigger >  0.5 && clampClose == false && liftTimer.seconds() > 0.5 || dist.getDistance(DistanceUnit.INCH)<2 && clampClose == false && liftTimer.seconds() > 0.5){ //claw close
